...
export const DetailsIcon = ({width='30', height='30'}) => {
	return (
		<>
			<span style={{cursor:'pointer'}} data-tip="Más detalles">
				<svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill="currentColor" className="bi bi-plus-circle" viewBox="0 0 16 16">
